...
G = '\033[1;32m'
S = '\033[1;33m'
de = 'https://api.whatsapp.com/send/?phone=201030093285'
webbrowser.open(de)
d = 0
os.system('clear')
...
def banner():
    ...
    print ('\t         \033[1;34m   ▇▇▇▏▃▆▅▎▅▆▃▕▇▇▇          ')
    print ('\t         \033[1;34m   ▇▇▇▏╱▔▕▎▔▔╲▕▇▇▇           ')
    print ('\t         \033[1;34m   ▇▇▇◣◣▃▅▎▅▃◢◢▇▇▇\033[2;32m  Code By :\033[2;31m Ahmed Zeko ')
    print ('\t         \033[1;34m   ▇▇▇▇◣◥▅▅▅◤◢▇▇▇▇             ')
    print ('\t         \033[1;34m   ▇▇▇▇▇◣╲▇╱◢▇▇▇▇▇      ')
    print ('\t         \033[1;34m   ▇▇▇▇▇▇◣▇◢▇▇▇▇▇▇            ')
    print(f'''  
 \t      {B}{E}==============================
\t      |{G}[+] GitHub    : {B}DEVZEKO   {E}|
\t      |{G}[+] Developer : {B}Return 🇪🇬     {E}|
\t      |{G}[+] TeleGram  : {B}Ahmed Zeko{E}|
\t      {E}==============================''')
